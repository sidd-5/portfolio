export default function About()  {
    return(
        <section id="abt" className="bg-[#ECF0F1] py-20 px-10">
  <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
    
    {/* Text Block */}
    <div className="bg-[#BDC3C7] p-8 rounded-2xl shadow-md w-full md:w-1/2">
      <h2 className="text-[#34495E] text-2xl font-semibold mb-4">About Me</h2>
      <p className="text-[#2C3E50] leading-7">
    ...
    {/* Image Block */}
    <div className="bg-[#BDC3C7] p-4 rounded-2xl shadow-lg w-fit flex justify-center">
      <img
        src="/image-og.png"
        alt="Siddhesh Chavan"
